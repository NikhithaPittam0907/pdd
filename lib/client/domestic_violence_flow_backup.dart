...
class _DomesticViolenceFlowScreenState extends State<DomesticViolenceFlowScreen> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _supportTile("Nearby Police Station", _caseResult?['nearest_police_station'] ?? "Women's Police Station, Sector 14 (2.5 km away)", Icons.local_police, const Color(0xFF1976D2)),
          _supportTile("Suggested Local Lawyer", _caseResult?['suggested_lawyer'] ?? "Adv. Priya Sharma (Family Law & Protection Expert)", Icons.person, goldColor),
          const SizedBox(height: 24),
  ...
  Widget _supportTile(String title, String subtitle, IconData icon, Color iconColor) {
    return Container(
  ...
  Widget _buildStep5FIRGenerator() {
    final draft = _caseResult?['complaint_draft'] ??
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text("The AI has drafted an official complaint based on your description. Please review and edit as needed.", style: GoogleFonts.inter(fontSize: 13, color: Colors.black54)),
